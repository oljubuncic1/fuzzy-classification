...
$HADOOP_PREFIX/bin/hadoop jar /usr/local/hadoop-2.7.1/share/hadoop/tools/lib/hadoop-streaming-2.7.1.jar -D mapreduce.job.reduces=$2  -cmdenv REDUCERN=$2 -mapper "/usr/local/bin/mapper $2" -reducer /usr/local/bin/reducer -input data000 -output output000
